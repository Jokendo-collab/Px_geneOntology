...
goplot(ego_BP) #Plot the enriched terms and their significance
...
##cnetplot(ego_BP,foldChange = geneList) #plot the interaction network, not good for a larg sent of proteins
